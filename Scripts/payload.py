...
validator = Validator(full_run=False)
...
class Payload:
    ...
    def payload_movie(self):
        ...
        validator.run_payload_check(payload, 'movie')
        return payload
    ...
    def payload_serie(self):
        ...
        validator.run_payload_check(payload, 'serie')
        return payload
    ...
    def payload_season(self):
        ...
        validator.run_payload_check(payload, 'season')
        return payload
    ...
    def payload_episode(self):
        ...
        validator.run_payload_check(payload, 'episode')
        return payload
